...
from .views import upload_audio, AudioListView, AudioDetailView, AudioUpdatePositionView, AudioUploadMultipleView, stream_audio
...
urlpatterns = [
    ...
    path('<int:pk>/stream/', stream_audio, name='audio-stream'),
